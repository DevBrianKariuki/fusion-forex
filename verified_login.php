...
<head>
  ...
  <title>Verified - Fusion Forex</title>
        ...
        <div class="row gy-8">
          ...
          <div class="col-lg-6" class="text-center  align-items-center" style="background-color: white; border-radius: 10px">
            <div class="portfolio-info">
                ...
                <p style="font-family: nunito;" class="text-success">Your email account has been verified succefully.<br>You can now <a href="login.php">login into your account</a></p>
            </div>
