...
<head>
  ...
  <title>Verify - Fusion Forex</title>
    ...
    <section id="portfolio-details" class="portfolio-details text-center" style="background-image: url('./assets/img/hero.png');">
      <div class="container">
        ...
        <div class="row gy-8">
          ...
          <div class="col-lg-6" class="text-center  align-items-center" style="background-color: white; border-radius: 10px">
            <div class="portfolio-info">
                <h3>Verify your email account</h3>
                <p style="font-family: nunito; font-style: italic;">Thank you for signing up.<br>Please follow the link sent to your email
                <a style="color: #e43c5c; cursor: pointer"><?php echo $_GET['email']; ?></a> account to verify your account</p>
            </div>
          </div>
