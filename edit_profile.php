                      ...
                      <div class="col-md-8">
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div>
                                <h6 class="mb-0 mt-2"><i>Please input your <b>current password</b> to update your details</i></h6>
                              </div>
                            </div>
                            <div class=" text-secondary mt-3 mb-2" style="font-family: poppins">
                              <input style="width: 100%; border-radius: 50px; font-size: 12px; font-family: poppins; color: #555; padding-left: 20px; border-color: grey" name="current-password" type="text" class="form-control" placeholder=" Current password" required>
                            </div>
                            <div class="row">
                              <div class="col-sm-12">
                                <button class="btn btn-primary" name="update" type="submit" style="width: 200px; background-color: #e43c5c; border: none; border-radius: 50px"><small>Update</small></button>
                              </div>
                            </div>
                            </form>
                          </div>
