                      ...
                      <div class="col-md-8">
                        <div class="card mb-3">
                          <div class="alert alert-info">
                            Please upload your ID below to confirm account ownership
                          </div>
                          <div class="card-body">
                            <form action="./includes/upload_ids.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                              <div class="col-sm-3">
                                <h6 class="mb-0 mt-4">ID Front<span style="color: red">*</span></h6>
                              </div>
                              <div class="col-sm-9 text-secondary mt-3" style="font-family: poppins">
                                <div class="input-group mb-2">
                                  <input style="width: 100%; border-radius: 50px; font-size: 12px; font-family: poppins; color: #555;  border-color: grey" name="front" type="file" class="form-control" required>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-sm-3">
                                <h6 class="mb-0 mt-4" >ID Back<span style="color: red">*</span></h6>
                              </div>
                              <div class="col-sm-9 text-secondary mt-3" style="font-family: poppins">
                                <input style="width: 100%; border-radius: 50px; font-size: 12px; font-family: poppins; color: #555;  border-color: grey" name="back" type="file" class="form-control"  required>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-sm-12">
                                <button class="btn btn-primary mt-4" type="submit" name="upload" style="width: 200px; border-radius: 50px"><small>Upload</small></button>
                              </div>
                            </div>
                          </div>
                          </form>
